...
export const ConversationsView: React.FC = () => {
  ...
  return (
    <div className="h-[calc(100vh-160px)] flex gap-6 animate-in fade-in slide-in-from-left-4 duration-500 overflow-hidden">
      ...
      <Card className="flex-1 flex flex-col bg-[#12121A] border-[#2A2A35] overflow-hidden rounded-2xl shadow-2xl">
        {selectedContact ? (
            ...
            <ScrollArea className="flex-1 p-8 bg-[#0B0B0F]/30">
               <div className="space-y-8">
                  <div className="flex justify-center">
                     <div className="px-3 py-1 bg-slate-900 border border-[#2A2A35] text-[9px] font-bold uppercase tracking-[0.2em] text-slate-500 rounded-full">Conversation History</div>
                  </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center space-y-4">
             ...
             <div>
                <h4 className="text-lg font-bold text-white">No conversation selected</h4>
                <p className="text-sm text-slate-500">Pick a lead from the left to view the conversation.</p>
             </div>
          </div>
        )}
      </Card>
      ...
      {/* Detail Panel */}
      <Card className="w-80 hidden xl:flex flex-col bg-[#12121A] shrink-0 overflow-hidden">
        {selectedContact ? (
          <ScrollArea className="flex-1">
            <div className="p-8 text-center space-y-6">
                <Avatar className="h-24 w-24 rounded-3xl mx-auto p-1 bg-[#0B0B0F]">
            ...
            <div className="p-8 space-y-8">
                <div className="space-y-4">
                  <h5 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] panel-title">Engagement Score</h5>
                ...
                <div className="space-y-4">
                  <h5 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] panel-title">AI Intelligence Report</h5>
                  <div className="p-5 rounded-2xl bg-[#0B0B0F] border border-[#2A2A35] space-y-4 border-l-4 border-l-primary shadow-inner">
                      <p className="text-[11px] leading-relaxed text-slate-300 font-medium">
                        No active intelligence report for {selectedContact.name}.
                      </p>
                ...
                <div className="space-y-3">
                  <h5 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] panel-title">Operations</h5>
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center text-slate-700">
             <Info className="w-12 h-12 mb-4" />
             <p className="text-sm font-bold uppercase tracking-widest">Select a Lead</p>
          </div>
        )}
      </Card>
    </div>
